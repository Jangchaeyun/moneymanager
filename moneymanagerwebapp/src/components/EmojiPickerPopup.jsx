...
import { HandPlatter, Image, X } from "lucide-react";
...
const EmojiPickerPopup = ({ icon, onSelect }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-5 mb-6">
      ...
      >
        <div className="w-12 h-12 flex items-center justify-center text-2xl bg-pink-50 text-pink-500 rounded-lg">
          {icon ? (
